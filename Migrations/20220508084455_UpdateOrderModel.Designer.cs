...
namespace BenthanysPieShop.Migrations
{
    ...
    [Migration("20220508084455_UpdateOrderModel")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BenthanysPieShop.Models.Category", b =>
                {
            ...
            modelBuilder.Entity("BenthanysPieShop.Models.Order", b =>
                {
            ...
            modelBuilder.Entity("BenthanysPieShop.Models.OrderDetail", b =>
                {
            ...
            modelBuilder.Entity("BenthanysPieShop.Models.Pie", b =>
                {
                    b.Property<int>("PieId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BenthanysPieShop.Models.ShoppingCartItem", b =>
                {
            ...
            modelBuilder.Entity("BenthanysPieShop.Models.OrderDetail", b =>
                {
                    b.HasOne("BenthanysPieShop.Models.Order", "Order")
                        .WithMany("OrderDetails")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BenthanysPieShop.Models.Pie", "Pie")
                        .WithMany()
                        .HasForeignKey("PieId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("BenthanysPieShop.Models.Pie", b =>
                {
                    b.HasOne("BenthanysPieShop.Models.Category", "Category")
                        .WithMany("Pies")
